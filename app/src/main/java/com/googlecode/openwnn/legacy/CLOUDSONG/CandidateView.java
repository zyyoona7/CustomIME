...
public class CandidateView extends View {
    ...
    public CandidateView(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray ta=context.obtainStyledAttributes(attrs,R.styleable.CandidateView);
        mTextSize=ta.getDimensionPixelSize(R.styleable.CandidateView_android_textSize,(int) TypedValue.applyDimension(
                TypedValue.COMPLEX_UNIT_SP, 23, getResources().getDisplayMetrics()));
        ta.recycle();
        init(context);
    }
...
//        onDraw(null);
     ...
     * @return
     */
    public List<WnnWord> getSuggestions(){
        if (mSuggestions==null){
